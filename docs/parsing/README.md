...
| YAML    | [yaml.md](yaml.md)    | Oracle parser + virtual brackets      |
...
|------------------------|-------------|--------------|---------------------------------------------------------------|
| SIMD character detect  | AVX2, NEON  | AVX2, NEON   | [simd.md](../optimizations/simd.md)                           |
...
| Rank/select indices    | BP nav      | Field lookup | [hierarchical-structures.md](../optimizations/hierarchical-structures.md) |
...
|--------|-------------|---------------------------|--------------|
| JSON   | x86_64 PFSM | AMD Ryzen 9 7950X (Zen 4) | ~880 MiB/s   |
...
- [YAML Analysis](yaml.md) - Ambiguity analysis, oracle model, optimization journey
- [YAML Conformance](../compliance/yaml/limitations.md) - YAML Test Suite results and known limitations
