...
**See also**: [YamlIndex wiki page](../yaml-index.md) for architecture overview and academic references | [YAML 1.2 Compliance](../compliance/yaml/1.2.md) for type handling details (Norway problem, booleans, etc.)
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.6 ms    |    5.8 ms    | **1.6x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    4.3 ms    |    7.6 ms    | **1.7x**      |    4 MB  |   13 MB | **0.33x** |
| **100KB**  |    4.9 ms    |   15.2 ms    | **3.1x**      |    5 MB  |   21 MB | **0.21x** |
| **1MB**    |   13.5 ms    |   88.0 ms    | **6.5x**      |    7 MB  |   89 MB | **0.09x** |
| **10MB**   |   94.3 ms    |  758.9 ms    | **8.1x**      |   32 MB  |  786 MB | **0.04x** |
| **100MB**  |  868.2 ms    |    7.36 s    | **8.5x**      |  247 MB  |    6 GB | **0.04x** |

**Key metrics:**
- ✅ **8.5x faster than yq** on 100MB files (comprehensive pattern)
- ✅ **13.1x faster than yq** on 100MB nested patterns (best performance)
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.4 ms    |    5.9 ms    | **1.7x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.4 ms    |    6.4 ms    | **1.9x**      |    4 MB  |   13 MB | **0.34x** |
| **100KB**  |    4.6 ms    |   15.7 ms    | **3.4x**      |    5 MB  |   21 MB | **0.21x** |
| **1MB**    |   13.3 ms    |   86.1 ms    | **6.5x**      |    7 MB  |   83 MB | **0.09x** |
| **10MB**   |   94.0 ms    |  765.8 ms    | **8.2x**      |   32 MB  |  733 MB | **0.04x** |
| **100MB**  |  861.4 ms    |    7.44 s    | **8.6x**      |  247 MB  |    5 GB | **0.05x** |

### Pattern: mixed

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.5 ms    |    5.8 ms    | **1.6x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.6 ms    |    6.7 ms    | **1.9x**      |    4 MB  |   13 MB | **0.33x** |
| **100KB**  |    4.6 ms    |   15.8 ms    | **3.4x**      |    5 MB  |   22 MB | **0.20x** |
| **1MB**    |   12.9 ms    |   87.1 ms    | **6.7x**      |    7 MB  |   92 MB | **0.08x** |
| **10MB**   |   93.1 ms    |  754.9 ms    | **8.1x**      |   33 MB  |  755 MB | **0.04x** |
| **100MB**  |  853.5 ms    |    7.96 s    | **9.3x**      |  253 MB  |    5 GB | **0.05x** |

### Pattern: navigation

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.4 ms    |    5.5 ms    | **1.6x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.4 ms    |    6.3 ms    | **1.9x**      |    4 MB  |   13 MB | **0.34x** |
| **100KB**  |    4.6 ms    |   15.5 ms    | **3.4x**      |    5 MB  |   22 MB | **0.21x** |
| **1MB**    |   12.8 ms    |   87.6 ms    | **6.9x**      |    7 MB  |   81 MB | **0.09x** |
| **10MB**   |   93.5 ms    |  791.0 ms    | **8.5x**      |   33 MB  |  707 MB | **0.05x** |
| **100MB**  |  880.1 ms    |    8.47 s    | **9.6x**      |  260 MB  |    6 GB | **0.04x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.5 ms    |    6.2 ms    | **1.8x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.6 ms    |    6.5 ms    | **1.8x**      |    4 MB  |   13 MB | **0.33x** |
| **100KB**  |    4.3 ms    |   15.9 ms    | **3.7x**      |    4 MB  |   21 MB | **0.21x** |
| **1MB**    |   10.0 ms    |   90.9 ms    | **9.1x**      |    7 MB  |   82 MB | **0.09x** |
| **10MB**   |   67.1 ms    |  801.0 ms    | **11.9x**     |   30 MB  |  614 MB | **0.05x** |
| **100MB**  |  614.1 ms    |    8.06 s    | **13.1x**     |  222 MB  |    6 GB | **0.04x** |

### Pattern: numbers

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.4 ms    |    5.7 ms    | **1.7x**      |    4 MB  |   12 MB | **0.37x** |
| **10KB**   |    3.3 ms    |    6.2 ms    | **1.9x**      |    4 MB  |   13 MB | **0.34x** |
| **100KB**  |    4.5 ms    |   14.2 ms    | **3.1x**      |    5 MB  |   20 MB | **0.23x** |
| **1MB**    |   13.7 ms    |   79.7 ms    | **5.8x**      |    7 MB  |   80 MB | **0.09x** |
| **10MB**   |   98.3 ms    |  677.4 ms    | **6.9x**      |   30 MB  |  617 MB | **0.05x** |
| **100MB**  |  895.9 ms    |    6.36 s    | **7.1x**      |  223 MB  |    5 GB | **0.04x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.4 ms    |    6.0 ms    | **1.7x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.5 ms    |    6.5 ms    | **1.9x**      |    4 MB  |   13 MB | **0.33x** |
| **100KB**  |    4.4 ms    |   17.0 ms    | **3.8x**      |    4 MB  |   22 MB | **0.20x** |
| **1MB**    |   12.3 ms    |  104.3 ms    | **8.5x**      |    7 MB  |   97 MB | **0.07x** |
| **10MB**   |   82.2 ms    |  907.3 ms    | **11.0x**     |   31 MB  |  707 MB | **0.04x** |
| **100MB**  |  720.2 ms    |    8.82 s    | **12.3x**     |  236 MB  |    6 GB | **0.04x** |

### Pattern: sequences

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.3 ms    |    5.7 ms    | **1.7x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.5 ms    |    6.3 ms    | **1.8x**      |    4 MB  |   13 MB | **0.34x** |
| **100KB**  |    4.6 ms    |   15.8 ms    | **3.4x**      |    5 MB  |   22 MB | **0.21x** |
| **1MB**    |   14.6 ms    |   90.8 ms    | **6.2x**      |    9 MB  |  105 MB | **0.08x** |
| **10MB**   |  109.9 ms    |  793.7 ms    | **7.2x**      |   51 MB  |  884 MB | **0.06x** |
| **100MB**  |    1.00 s    |    8.03 s    | **8.0x**      |  389 MB  |    6 GB | **0.06x** |

### Pattern: strings

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.4 ms    |    5.6 ms    | **1.7x**      |    4 MB  |   12 MB | **0.37x** |
| **10KB**   |    3.3 ms    |    5.8 ms    | **1.8x**      |    4 MB  |   12 MB | **0.35x** |
| **100KB**  |    4.1 ms    |   11.6 ms    | **2.8x**      |    4 MB  |   18 MB | **0.24x** |
| **1MB**    |   10.2 ms    |   55.0 ms    | **5.4x**      |    7 MB  |   60 MB | **0.12x** |
| **10MB**   |   69.7 ms    |  449.4 ms    | **6.5x**      |   29 MB  |  475 MB | **0.06x** |
| **100MB**  |  629.4 ms    |    4.43 s    | **7.0x**      |  204 MB  |    5 GB | **0.04x** |

### Pattern: unicode

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    4.2 ms    |    9.6 ms    | **2.3x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    5.1 ms    |   11.0 ms    | **2.2x**      |    4 MB  |   12 MB | **0.36x** |
| **100KB**  |    4.2 ms    |   11.3 ms    | **2.7x**      |    4 MB  |   18 MB | **0.25x** |
| **1MB**    |   10.1 ms    |   53.5 ms    | **5.3x**      |    7 MB  |   58 MB | **0.12x** |
| **10MB**   |   65.6 ms    |  436.1 ms    | **6.6x**      |   33 MB  |  451 MB | **0.07x** |
| **100MB**  |  609.2 ms    |    4.21 s    | **6.9x**      |  205 MB  |    4 GB | **0.05x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.6 ms    |    6.2 ms    | **1.7x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.5 ms    |    6.5 ms    | **1.9x**      |    4 MB  |   13 MB | **0.34x** |
| **100KB**  |    4.6 ms    |   16.0 ms    | **3.5x**      |    4 MB  |   22 MB | **0.21x** |
| **1MB**    |   13.2 ms    |   96.7 ms    | **7.3x**      |    7 MB  |   96 MB | **0.08x** |
| **10MB**   |   97.1 ms    |  888.4 ms    | **9.2x**      |   34 MB  |  903 MB | **0.04x** |
| **100MB**  |  908.9 ms    |    9.68 s    | **10.6x**     |  268 MB  |    7 GB | **0.04x** |
