...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    4.2 ms    |    7.0 ms    | **1.7x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    4.3 ms    |    7.6 ms    | **1.7x**      |    5 MB  |   13 MB | **0.35x** |
| **100KB**  |    4.9 ms    |   15.2 ms    | **3.1x**      |    5 MB  |   21 MB | **0.21x** |
| **1MB**    |   13.5 ms    |   88.0 ms    | **6.5x**      |    7 MB  |   85 MB | **0.09x** |
...
| **100KB**  |    4.9 ms    |   15.2 ms    | **3.1x**      |    5 MB  |   21 MB | **0.21x** |
| **1MB**    |   13.5 ms    |   88.0 ms    | **6.5x**      |    7 MB  |   85 MB | **0.09x** |
| **10MB**   |   94.3 ms    |  758.9 ms    | **8.1x**      |   32 MB  |  723 MB | **0.04x** |
| **100MB**  |  853.3 ms    |    7.81 s    | **9.2x**      |  247 MB  |    5 GB | **0.04x** |

### Pattern: mixed

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.5 ms    |    6.1 ms    | **1.7x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.6 ms    |    6.2 ms    | **1.7x**      |    4 MB  |   13 MB | **0.33x** |
| **100KB**  |    4.5 ms    |   15.4 ms    | **3.5x**      |    5 MB  |   22 MB | **0.21x** |
| **1MB**    |   12.8 ms    |   90.1 ms    | **7.0x**      |    7 MB  |   88 MB | **0.08x** |
| **10MB**   |   94.0 ms    |  782.8 ms    | **8.3x**      |   33 MB  |  816 MB | **0.04x** |
| **100MB**  |  853.6 ms    |    7.56 s    | **8.9x**      |  253 MB  |    6 GB | **0.04x** |

### Pattern: navigation

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.3 ms    |    5.6 ms    | **1.7x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.4 ms    |    6.2 ms    | **1.8x**      |    4 MB  |   13 MB | **0.34x** |
| **100KB**  |    4.6 ms    |   14.3 ms    | **3.1x**      |    5 MB  |   21 MB | **0.21x** |
| **1MB**    |   12.6 ms    |   86.7 ms    | **6.9x**      |    7 MB  |   82 MB | **0.09x** |
| **10MB**   |   92.4 ms    |  778.1 ms    | **8.4x**      |   33 MB  |  723 MB | **0.05x** |
| **100MB**  |  870.9 ms    |    8.15 s    | **9.4x**      |  260 MB  |    6 GB | **0.04x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    6.6 ms    |    6.9 ms    | **1.0x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.6 ms    |    6.5 ms    | **1.8x**      |    4 MB  |   13 MB | **0.33x** |
| **100KB**  |    4.1 ms    |   14.9 ms    | **3.7x**      |    5 MB  |   22 MB | **0.21x** |
| **1MB**    |   10.0 ms    |   89.0 ms    | **8.9x**      |    7 MB  |   79 MB | **0.09x** |
| **10MB**   |   65.8 ms    |  791.0 ms    | **12.0x**     |   30 MB  |  632 MB | **0.05x** |
| **100MB**  |  608.5 ms    |    8.17 s    | **13.4x**     |  222 MB  |    6 GB | **0.04x** |

### Pattern: numbers

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.5 ms    |    5.7 ms    | **1.6x**      |    4 MB  |   12 MB | **0.37x** |
| **10KB**   |    3.4 ms    |    6.3 ms    | **1.9x**      |    4 MB  |   13 MB | **0.34x** |
| **100KB**  |    4.4 ms    |   13.9 ms    | **3.1x**      |    5 MB  |   20 MB | **0.22x** |
| **1MB**    |   13.7 ms    |   80.1 ms    | **5.9x**      |    7 MB  |   78 MB | **0.09x** |
| **10MB**   |   97.6 ms    |  671.0 ms    | **6.9x**      |   30 MB  |  610 MB | **0.05x** |
| **100MB**  |  891.2 ms    |    6.43 s    | **7.2x**      |  223 MB  |    5 GB | **0.04x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.3 ms    |    5.5 ms    | **1.6x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.3 ms    |    6.4 ms    | **1.9x**      |    4 MB  |   13 MB | **0.33x** |
| **100KB**  |    4.3 ms    |   16.5 ms    | **3.8x**      |    5 MB  |   22 MB | **0.20x** |
| **1MB**    |   12.4 ms    |  101.5 ms    | **8.2x**      |    7 MB  |   89 MB | **0.08x** |
| **10MB**   |   84.1 ms    |  896.0 ms    | **10.7x**     |   31 MB  |  745 MB | **0.04x** |
| **100MB**  |  741.9 ms    |    8.71 s    | **11.7x**     |  236 MB  |    6 GB | **0.04x** |

### Pattern: sequences

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.5 ms    |    5.6 ms    | **1.6x**      |    4 MB  |   12 MB | **0.36x** |
| **10KB**   |    3.4 ms    |    6.2 ms    | **1.8x**      |    4 MB  |   13 MB | **0.33x** |
| **100KB**  |    4.7 ms    |   15.4 ms    | **3.3x**      |    5 MB  |   22 MB | **0.22x** |
| **1MB**    |   14.7 ms    |   89.7 ms    | **6.1x**      |    9 MB  |  106 MB | **0.08x** |
| **10MB**   |  108.5 ms    |  798.0 ms    | **7.4x**      |   46 MB  |  863 MB | **0.05x** |
| **100MB**  |  998.3 ms    |    8.08 s    | **8.1x**      |  389 MB  |    6 GB | **0.06x** |

### Pattern: strings

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.4 ms    |    5.6 ms    | **1.6x**      |    4 MB  |   12 MB | **0.37x** |
| **10KB**   |    3.4 ms    |    5.8 ms    | **1.7x**      |    4 MB  |   12 MB | **0.35x** |
| **100KB**  |    4.0 ms    |   11.1 ms    | **2.8x**      |    5 MB  |   18 MB | **0.25x** |
| **1MB**    |   10.2 ms    |   54.4 ms    | **5.3x**      |    7 MB  |   58 MB | **0.12x** |
| **10MB**   |   68.9 ms    |  455.5 ms    | **6.6x**      |   29 MB  |  448 MB | **0.06x** |
| **100MB**  |  629.3 ms    |    4.37 s    | **7.0x**      |  204 MB  |    5 GB | **0.04x** |

### Pattern: unicode

| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    3.3 ms    |    5.5 ms    | **1.7x**      |    4 MB  |   12 MB | **0.37x** |
| **10KB**   |    3.3 ms    |    6.0 ms    | **1.8x**      |    4 MB  |   12 MB | **0.35x** |
| **100KB**  |    4.1 ms    |   10.9 ms    | **2.7x**      |    4 MB  |   18 MB | **0.25x** |
| **1MB**    |    9.8 ms    |   52.5 ms    | **5.3x**      |    7 MB  |   59 MB | **0.12x** |
| **10MB**   |   67.1 ms    |  426.4 ms    | **6.4x**      |   29 MB  |  474 MB | **0.06x** |
| **100MB**  |  603.3 ms    |    4.15 s    | **6.9x**      |  205 MB  |    4 GB | **0.05x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    6.7 ms    |    6.2 ms    | **0.9x**      |    4 MB  |   12 MB | **0.37x** |
| **10KB**   |    3.7 ms    |    7.2 ms    | **2.0x**      |    4 MB  |   13 MB | **0.33x** |
| **100KB**  |    4.6 ms    |   16.2 ms    | **3.5x**      |    5 MB  |   22 MB | **0.21x** |
| **1MB**    |   13.1 ms    |   96.5 ms    | **7.4x**      |    7 MB  |  100 MB | **0.07x** |
| **10MB**   |   96.0 ms    |  888.9 ms    | **9.3x**      |   34 MB  |  887 MB | **0.04x** |
| **100MB**  |  901.1 ms    |    9.59 s    | **10.6x**     |  268 MB  |    6 GB | **0.04x** |
