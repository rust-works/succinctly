...
| Size       | succinctly             | yq                     | Speedup     | Mem Ratio  |
|------------|------------------------|------------------------|-------------|------------|
| **10KB**   |   3.5 ms  (2.8 MiB/s)  |   6.5 ms  (1.5 MiB/s)  | **1.8x**    | **0.33x**  |
| **100KB**  |   4.6 ms (21.2 MiB/s)  |  14.9 ms  (6.5 MiB/s)  | **3.2x**    | **0.21x**  |
| **1MB**    |  13.1 ms (76.3 MiB/s)  |  84.6 ms (11.8 MiB/s)  | **6.5x**    | **0.08x**  |
| **10MB**   |  94.5 ms (105.8 MiB/s) | 741.7 ms (13.5 MiB/s)  | **7.9x**    | **0.04x**  |
| **100MB**  | 873.9 ms (114.4 MiB/s) |   7.03 s (14.2 MiB/s)  | **8.0x**    | **0.04x**  |
