...
| `unshared-containers`| Measurement-only: the pre-sharing layout (boxed map, inline array `Vec`, inline `String`, `Box<str>` spelling) instead of `Rc` storage (#2999/#3182 A/B holdout; never ship) |
